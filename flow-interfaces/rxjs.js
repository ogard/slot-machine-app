...
declare class rxjs$Observable<+T> {
  ...
  static bindCallback<T, T2, T3, T4, U>(
    callbackFunc: (v1: T, v2: T2, v3: T3, v4: T4, callback: (result: U) => any) => any,
    selector?: void,
    scheduler?: rxjs$SchedulerClass,
  ...
  static bindCallback<T, T2, U>(
    callbackFunc: (v1: T, v2: T2, callback: (...args: Array<any>) => any) => any,
    selector: (...args: Array<any>) => U,
    scheduler?: rxjs$SchedulerClass,
  ): (v1: T, v2: T2) => rxjs$Observable<U>;
  static bindCallback<T, T2, T3, U>(
    callbackFunc: (v1: T, v2: T2, v3: T3, callback: (...args: Array<any>) => any) => any,
    selector: (...args: Array<any>) => U,
    scheduler?: rxjs$SchedulerClass,
  ): (v1: T, v2: T2, v3: T3) => rxjs$Observable<U>;
  static bindCallback<T, T2, T3, T4, U>(
  ...
  static bindNodeCallback<T, T2, U>(
    callbackFunc: (v1: T, v2: T2, callback: (err: any, result: U) => any) => any,
    selector?: void,
    scheduler?: rxjs$SchedulerClass,
  ): (v1: T, v2: T2) => rxjs$Observable<U>;
  static bindNodeCallback<T, T2, T3, U>(
    callbackFunc: (v1: T, v2: T2, v3: T3, callback: (err: any, result: U) => any) => any,
    selector?: void,
    scheduler?: rxjs$SchedulerClass,
  ): (v1: T, v2: T2, v3: T3) => rxjs$Observable<U>;
  ...
  groupBy<K, V>(
    ...
    durationSelector?: (grouped: rxjs$GroupedObservable<K, V>) => rxjs$Observable<any>,
  ...
  pipe<A, B>(op1: rxjs$OperatorFunction<T, A>, op2: rxjs$OperatorFunctionLast<A, B>): B;
  ...
  zip<A, B>(a: rxjs$Observable<A>, resultSelector: (t: T, a: A) => B): rxjs$Observable<B>;
  ...
  static forkJoin<A>(a: Array<rxjs$Observable<A>>, _: void): rxjs$Observable<Array<A>>;

  static forkJoin<A>(a: Array<rxjs$Observable<any>>, _: void): rxjs$Observable<A>;
